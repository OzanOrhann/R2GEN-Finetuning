...
Modeli pretrained üzerine eğitmek için: python test.py --resume checkpoints/model_iu_xray.pth

checkpoints isimli bir klasör oluşturulacak ve modelin ağırlıkları bu klasöre kaydedilecektir.(model_iu_xray.pth)
